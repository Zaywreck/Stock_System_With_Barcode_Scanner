namespace Guven_Barkod_BackEnd.Entities
{
    public class Product
    {
        ...
        public double Product_Purch_Price { get; set; }
        ...
        public Product(string barcode_ID, string product_Name, string product_Model, string product_Color, string product_Size, double product_Price, double product_Purch_Price)
        {
            ...
            Product_Purch_Price = product_Purch_Price;
        }
